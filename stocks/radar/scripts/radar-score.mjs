/**
 * Weighted radar action bias — shared by digests / alerts (Node).
 * Keep in sync with src/lib/market-display.ts actionBias().
 *
...
export function isPreMomentum(q) {
  ...
  return volQuiet && rsiMid && nearOrUnder50 && notHigh && notAth;
}
