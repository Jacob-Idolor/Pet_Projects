...
# Load the CSV data
csv_data = pd.read_csv('PickEm\PlayerProjections.csv')  # Replace with your CSV file path

# Extract player names from nba_player_projections.csv
player_names_csv = set(csv_data['Player Name'])

# Load the JSON data
game_logs_data = load_json('PickEm\PrizePicksLines.json')  # Replace with your JSON file path
