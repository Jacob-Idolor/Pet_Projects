...
for player in active_players:
    player_id = player['id']
    game_logs = playergamelog.PlayerGameLog(player_id=player_id, season='2023-24')
...
file_path = 'player_game_logs_2023_2024.json'
all_player_game_logs.to_json(file_path, orient='records')

# Confirming the file save
print("Player game logs for the 2023-2024 season have been saved to 'player_game_logs_2023_2024.json'")
