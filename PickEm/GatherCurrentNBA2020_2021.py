...
for player in active_players:
    player_id = player['id']
    game_logs = playergamelog.PlayerGameLog(player_id=player_id, season='2020-21')
...
file_path = 'game_logs_2020_2021.json'
all_player_game_logs.to_json(file_path, orient='records')

# Confirming the file save
print("Player game logs for the 2020-2021 season have been saved to 'game_logs_2020_2021.json'")
